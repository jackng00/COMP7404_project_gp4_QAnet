...
train_file_finqa = os.path.join(home, "data", "finqa", "train_turn.json")
dev_file_finqa = os.path.join(home, "data", "finqa", "dev_turn.json")
test_file_finqa = os.path.join(home, "data", "finqa", "test_turn_private.json")
glove_word_file = os.path.join(home, "data", "glove", "glove.840B.300d.txt")
target_dir = "data"
event_dir = "log"
save_dir = "model_finqa"
pre_dir = "model_ori" ## load pre model
answer_dir = "log"
...
flags.DEFINE_string("model", "qanet", "qanet/finqa")

flags.DEFINE_string("target_dir", target_dir, "")
flags.DEFINE_string("event_dir", event_dir, "")
flags.DEFINE_string("save_dir", save_dir, "")
flags.DEFINE_string("pre_dir", pre_dir, "") # load pre model
flags.DEFINE_string("train_file", train_file, "")
flags.DEFINE_string("dev_file", dev_file, "")
flags.DEFINE_string("test_file", test_file, "")
flags.DEFINE_string("train_file_finqa", train_file_finqa, "") # finqa_dataset
flags.DEFINE_string("dev_file_finqa", dev_file_finqa, "") # finqa_dataset
flags.DEFINE_string("test_file_finqa", test_file_finqa, "") # finqa_dataset
...
flags.DEFINE_integer("para_limit", 2000, "Limit length for paragraph")
